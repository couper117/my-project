...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, label, error, hint, required, placeholder, id, children, options, ...props }, ref) => {
    const inputId = id || label?.toLowerCase().replace(/\s+/g, '-') || 'select';
      ...
      <div className="w-full">
        ...
        <div className="relative">
          <select
            ...
            ref={ref}
            className={cn(
              'w-full border rounded-lg transition-colors duration-200 px-4 py-2.5 text-sm appearance-none',
