...
import { HajjRegisterForm } from '@/components/hajj/HajjRegisterForm';

export default async function HajjRegisterPage({ params: { locale } }: { params: { locale: string } }) {
  const t = await getTranslations('services.hajj.register');
