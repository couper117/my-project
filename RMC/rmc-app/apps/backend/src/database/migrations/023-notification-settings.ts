 ...
 * Each row represents one notification event and stores whether it should
 * be dispatched via email, SMS, or both.
 */
export class NotificationSettings1782300000000 implements MigrationInterface {
  name = 'NotificationSettings1782300000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    /* Seed default rows for all known notification events */
    await queryRunner.query(`
