...
(function (ContactMessageStatus) {
    ContactMessageStatus["UNREAD"] = "unread";
...
__decorate([
    (0, typeorm_1.Index)('IDX_contact_messages_status'),
    (0, typeorm_1.Column)({ type: 'varchar', length: 20, default: ContactMessageStatus.UNREAD }),
    __metadata("design:type", String)
], ContactMessage.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.Index)('IDX_contact_messages_created_at'),
