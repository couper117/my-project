...
], LocationsController.prototype, "findProvinces", null);
__decorate([
    (0, common_1.Get)('districts'),
    (0, public_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get districts, optionally filtered by province' }),
    (0, swagger_1.ApiQuery)({ name: 'provinceId', required: false }),
    __param(0, (0, common_1.Query)('provinceId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], LocationsController.prototype, "findDistricts", null);
__decorate([
    (0, common_1.Get)('sectors'),
    (0, public_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get sectors, optionally filtered by district' }),
    (0, swagger_1.ApiQuery)({ name: 'districtId', required: false }),
    __param(0, (0, common_1.Query)('districtId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], LocationsController.prototype, "findSectors", null);
__decorate([
    (0, common_1.Get)('areas'),
    (0, public_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get areas, optionally filtered by district' }),
    (0, swagger_1.ApiQuery)({ name: 'districtId', required: false }),
    __param(0, (0, common_1.Query)('districtId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], LocationsController.prototype, "findAreas", null);
